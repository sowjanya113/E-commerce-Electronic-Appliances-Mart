...
// 2.Kichen section
document.getElementById('kichenBtn').addEventListener('click', function() {
  window.location.href = 'kichenappliances.html';
});

// 3.Cleaning section
document.getElementById('cleaningBtn').addEventListener('click', function() {
  window.location.href = 'cleaningappliances.html';
});

// 4.bathing section
document.getElementById('bathingBtn').addEventListener('click', function() {
  window.location.href = 'bathingappliances.html';
});
